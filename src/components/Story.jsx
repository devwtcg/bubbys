      ...
      <div className="wrap" style={{
        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ position: "absolute", top: -22, left: 24, padding: "4px 10px", background: "var(--paper)", border: "2.5px solid var(--ink)", borderRadius: 6, fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".18em", textTransform: "uppercase" }}>
              FROM THE KITCHEN
            </div>
            <p style={{ margin: 0 }}>
            ...
            <div style={{ marginTop: 12, fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".14em", textTransform: "uppercase" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginTop: 36 }}>
            {[
              ...
              <div key={n} style={{ borderTop: "2.5px solid var(--ink)", paddingTop: 14 }}>
                ...
                <div style={{ fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".14em", textTransform: "uppercase", marginTop: 4 }}>{l}</div>
              </div>
            ))}
          </div>
        </div>
