      ...
      <div className="wrap" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              <div style={{ fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".22em", textTransform: "uppercase" }}>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 24 }}>
          <BubbySays color="var(--orange)" tilt={4} tail="br" style={{ maxWidth: 300 }}>
            ...
            <span style={{ fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".14em", textTransform: "uppercase", color: "var(--paper)", display: "inline-block", marginTop: 6 }}>— Bubby, at every gathering</span>
          </BubbySays>
        </div>
        ...
        <div style={{
          ...
          {tiers.map((t) => (
            <div key={t.name} style={{
              ...
              <div style={{ fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".2em", textTransform: "uppercase", opacity: .75 }}>
                {t.serves}
              </div>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                ...
                <div style={{ fontFamily: "var(--mono)", fontSize: 16, letterSpacing: ".14em", textTransform: "uppercase", opacity: .75 }}>
                  {t.perPerson ? "/ person" : "flat"}
                </div>
              </div>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 10 }}>
                {t.includes.map((x, j) => (
                  <li key={j} style={{ display: "flex", gap: 10, fontSize: 16, lineHeight: 1.3 }}>
